  ...
  return (
    <View style={styles.container}>
        ...
        {activities.length > 0 ? (
          activities.slice(0, 1).map((activity) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("HistoryScreen", { userId: user })
              }
            >
              <View
                style={{
      ...
      <View style={styles.navBar}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("HomeScreen", { userId: user })}>
          <Ionicons
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate("ProfileScreen", { userId: user })}
        >
          <Ionicons
